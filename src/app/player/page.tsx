...
export const metadata: Metadata = {
  title: "Video Comparison Player | OpenTimelineIO",
  description: "Interactive video comparison player showcasing OpenTimelineIO capabilities.",
  openGraph: {
    title: "Video Comparison Player | OpenTimelineIO",
    description: "Interactive video comparison player showcasing OpenTimelineIO capabilities.",
    type: "website",
    url: getFullUrl("/player"),
