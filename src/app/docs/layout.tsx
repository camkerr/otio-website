...
export default function DocsLayout({
  ...
  return (
    <NavWidthSetter width="full">
      <div className="flex w-full h-[calc(100vh-var(--top-nav-height))]">
        {/* Hide sidebar on mobile, show only on desktop */}
        <aside className="hidden md:block sticky top-0 h-[calc(100vh-var(--top-nav-height))] w-[280px] md:w-[320px] shrink-0">
